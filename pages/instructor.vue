    ...
    <v-toolbar>
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on, attrs }">
          <v-btn class="white black--text" v-bind="attrs" v-on="on" to>Create Course</v-btn>
        </template>
    ...
    <v-layout row wrap>
      ...
      >
        <v-card class="mx-auto" max-width="344" elevation="20" ripple rounded>
            <v-tooltip bottom>
              <template v-slot:activator="{ on, attrs }">
               <v-btn class="mx-1" absolute fab mt-3 right small dark color="black" v-bind="attrs" v-on="on">
